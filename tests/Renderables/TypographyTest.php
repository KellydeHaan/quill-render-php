...
final class TypographyTest extends \PHPUnit\Framework\TestCase
{
    ...
    private $expected_bold_with_following_break = '<p><strong>Bold text</strong></p>
<p>Any text</p>';
    ...
    public function testBold()
    {
        ...
        try {
            $quill = \Oberon\Quill\Render\Html\HtmlParser::withQuill($this->delta_bold);
            $result = $quill->render();
        } catch (\Exception $e) {
    ...
    public function testBoldWithAttribute()
    {
        ...
        try {
            $quill = \Oberon\Quill\Render\Html\HtmlParser::withQuill($this->delta_bold_with_attributes);
            $result = $quill->render();
        } catch (\Exception $e) {
            $this->fail(__METHOD__.'failure, '.$e->getMessage());
        }
        ...
        $this->assertEquals(
            $this->expected_bold_with_attributes,
            trim($result),
            __METHOD__.' - Bold attribute with attributes failure'
        );
    }
    ...
    public function testBoldWithFollowingBreak()
    {
        ...
        try {
            $quill = \Oberon\Quill\Render\Html\HtmlParser::withQuill($this->delta_bold_with_following_break);
            $result = $quill->render();
        } catch (\Exception $e) {
            $this->fail(__METHOD__.'failure, '.$e->getMessage());
        }
        ...
        $this->assertEquals(
            $this->expected_bold_with_following_break,
            trim($result),
            __METHOD__.' - Bold attribute, text following with leading break'
        );
    }
    ...
    public function testItalic()
    {
        ...
        try {
            $quill = \Oberon\Quill\Render\Html\HtmlParser::withQuill($this->delta_italic);
            $result = $quill->render();
        } catch (\Exception $e) {
            $this->fail(__METHOD__.'failure, '.$e->getMessage());
        }
    ...
    public function testStrike()
    {
        ...
        try {
            $quill = \Oberon\Quill\Render\Html\HtmlParser::withQuill($this->delta_strike);
            $result = $quill->render();
        } catch (\Exception $e) {
            $this->fail(__METHOD__.'failure, '.$e->getMessage());
        }
    ...
    public function testSubScript()
    {
        ...
        try {
            $quill = \Oberon\Quill\Render\Html\HtmlParser::withQuill($this->delta_sub_script);
            $result = $quill->render();
        } catch (\Exception $e) {
            $this->fail(__METHOD__.'failure, '.$e->getMessage());
        }
    ...
    public function testSuperScript()
    {
        ...
        try {
            $quill = \Oberon\Quill\Render\Html\HtmlParser::withQuill($this->delta_super_script);
            $result = $quill->render();
        } catch (\Exception $e) {
            $this->fail(__METHOD__.'failure, '.$e->getMessage());
        }
    ...
    public function testUnderline()
    {
        ...
        try {
            $quill = \Oberon\Quill\Render\Html\HtmlParser::withQuill($this->delta_underline);
            $result = $quill->render();
        } catch (\Exception $e) {
            $this->fail(__METHOD__.'failure, '.$e->getMessage());
        }
    ...
    public function testSingleAttribute()
    {
        ...
        try {
            $quill = \Oberon\Quill\Render\Html\HtmlParser::withQuill($this->delta_single_attribute);
            $result = $quill->render();
        } catch (\Exception $e) {
            $this->fail(__METHOD__.'failure, '.$e->getMessage());
        }
