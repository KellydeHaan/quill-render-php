...
<p>of HTML.</p>';
    private $expected_line_breaks = "<p>Line 1, should have a BR</p>
<p>Line 2, should have a BR</p>
<p>Line 3</p>";
    private $expected_paragraph_then_line_breaks = "<p>Paragraph</p>
<p>Line 1, should have a BR</p>
<p>Line 2, should have a BR</p>
<p>Line 3</p>";
    ...
    public function testParagraphWithAttributes()
    {
        ...
        try {
            $quill = \Oberon\Quill\Render\Html\HtmlParser::withQuill($this->delta_paragraphs_with_attributes);
            $result = $quill->render();
        } catch (\Exception $e) {
    ...
    public function testSingleParagraph()
    {
        ...
        try {
            $quill = \Oberon\Quill\Render\Html\HtmlParser::withQuill($this->delta_single_paragraph);
            $result = $quill->render();
        } catch (\Exception $e) {
            $this->fail(__METHOD__.'failure, '.$e->getMessage());
        }
    ...
    public function testTwoParagraphs()
    {
        ...
        try {
            $quill = \Oberon\Quill\Render\Html\HtmlParser::withQuill($this->delta_two_paragraphs);
            $result = $quill->render();
        } catch (\Exception $e) {
            $this->fail(__METHOD__.'failure, '.$e->getMessage());
        }
    ...
    public function testThreeParagraphs()
    {
        ...
        try {
            $quill = \Oberon\Quill\Render\Html\HtmlParser::withQuill($this->delta_three_paragraphs);
            $result = $quill->render();
        } catch (\Exception $e) {
            $this->fail(__METHOD__.'failure, '.$e->getMessage());
        }
    ...
    public function testTwoLineBreaksInAParagraph()
    {
        ...
        try {
            $quill = \Oberon\Quill\Render\Html\HtmlParser::withQuill($this->delta_line_breaks);
            $result = $quill->render();
        } catch (\Exception $e) {
            $this->fail(__METHOD__.'failure, '.$e->getMessage());
        }
    ...
    public function testParagraphThenTwoLineBreaksInAParagraphFollowingParagraph()
    {
        ...
        try {
            $quill = \Oberon\Quill\Render\Html\HtmlParser::withQuill($this->delta_paragraph_then_line_breaks);
            $result = $quill->render();
        } catch (\Exception $e) {
            $this->fail(__METHOD__.'failure, '.$e->getMessage());
        }
