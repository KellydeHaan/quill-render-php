...
final class HrefTest extends \PHPUnit\Framework\TestCase
{
    ...
    private $expected_href = '<p>Lorem ipsum dolor sit amet, <a href="http://www.example.com">consectetur</a> adipiscing elit. In sed efficitur enim. Suspendisse mattis purus id odio varius suscipit. Nunc posuere fermentum blandit. </p>
<p>In vitae eros nec mauris dignissim porttitor. Morbi a tempus tellus. Mauris quis velit sapien. <a href="http://www.example.com">Etiam </a>sit amet enim venenatis, eleifend lectus ac, ultricies orci. Sed tristique laoreet mi nec imperdiet. Vivamus non dui diam. Aliquam erat eros, dignissim in quam id.</p>';
    ...
    public function testLink()
    {
        ...
        try {
            $quill = \Oberon\Quill\Render\Html\HtmlParser::withQuill($this->delta_href);
            $result = $quill->render();
        } catch (\Exception $e) {
